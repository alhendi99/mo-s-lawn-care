...
for (const futureId of ['our-work', 'reviews', 'contact', 'blog'] as const) {
...
assert.match(planSource, /### Task 24 — Our Work and Gallery Page\n\n- \*\*Status:\*\* `\[ \]` Not started/)

console.log(
  'Task 23 About validation passed: exact ownership, verified company facts, AboutPage/Organization/WebSite/BreadcrumbList graph, five-area and ten-service scope, required links, future-route isolation, Spanish coverage, and exact nineteen-URL sitemap lifecycle.',
)
