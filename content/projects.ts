...
export const workRecords = [
  record({ id: 'local-gallery-01', src: '/media/lawn-mowing.webp', width: 1600, height: 1200, altKey: 'striped-residential', displayOrder: 1, homepageEligible: true, displayEligible: true, source: 'repository-local-gallery', note: "Repository-local gallery file; no city, customer or service attribution." }),
