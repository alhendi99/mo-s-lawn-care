...
for (const invalid of ['des-moines-ia', 'norwalk', 'norwalk-iowa', 'invalid-city']) {
...
for (const publishedId of ['service-area-ankeny', 'service-area-waukee', 'service-area-altoona'] as const) {
